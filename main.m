...
m = 2;%pCon*T/2;           % Nodes to add each time step (to get aprox same deg)
offset = 4;
...
[a_exp_diameters, a_exp_frac_vals,a_exp_S_avg,a_exp_S_max] = sim_attack(exp_network, m_frac_val, res);
[a_sf_diameters, a_sf_frac_vals,a_sf_S_avg,a_sf_S_max] = sim_attack(sf_network, m_frac_val, res);
